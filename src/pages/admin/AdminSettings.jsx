  ...
  return (
    <div>
      ...
      <div style={{padding:'2.5rem',display:'flex',flexDirection:'column',gap:'2rem',maxWidth:'820px'}}>
        ...
        <div style={{background:'var(--surface)',border:'1px solid #2A2826',padding:'2rem'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'8px',marginBottom:'1.5rem'}}>
              {fields.map((f) => (
                <div key={f.key} style={{
                  ...
                  padding:'10px 14px',
                  background: f.visible ? 'rgba(196,168,130,0.04)' : 'transparent',
                  border:`1px solid ${f.visible ? 'rgba(196,168,130,0.15)' : '#2A2826'}`,
                  transition:'all 0.2s',
                }}>
        ...
        <div style={{background:'var(--surface)',border:'1px solid #2A2826',padding:'2rem'}}>
          ...
          {customFields.length > 0 && (
            <div style={{display:'flex',flexDirection:'column',gap:'8px',marginBottom:'1rem'}}>
              {customFields.map(f => (
                <div key={f.key} style={{display:'flex',alignItems:'center',gap:'10px',padding:'8px 12px',border:'1px solid #2A2826',background:'rgba(196,168,130,0.03)'}}>
